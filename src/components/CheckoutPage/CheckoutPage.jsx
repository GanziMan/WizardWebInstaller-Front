            ...
            {({ isSubmitting }) => (
              <Form id={formId}>
                ...
                <div className={classes.buttons}>
                  ...
                  ):(activeStep === 3 ? (<Button onClick={_handleBack} style={{bottom:"25px"}} className={classes.button}>
                  Back
                </Button>):(<></>))}
                  <div className={classes.wrapper}>

                    {
                    activeStep === 1 && result.AccountReducer.result !== false ? (
                      <Button
                        // disabled={isAn}
                        disabled={false}
                        type="submit"
                     ...
                     activeStep === 4 ? (<div></div>):( activeStep===3 ? (<></>):(<Button
